...
public class Admis extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == jb1) {
            ...
            String query = "select matricule, nom, prenom, AVG(valeur) from etudiants e, notes n where e.matricule=n.code  group by e.nom, e.prenom having AVG(valeur)>=12 order by AVG(valeur) desc;";
