...
public class NonAdmis extends JFrame implements ActionListener {
    ...
    public NonAdmis() {
        ...
        add(pn);
        //
        lab1 = new JLabel("LISTE DES ETUDIANTS ADMIS");
    ...
    public void actionPerformed(ActionEvent e) {
        jb2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                ...
                NonAdmis.this.setVisible(false);
        ...
        if (e.getSource() == jb1) {
            ...
            String query = "select matricule, nom, prenom, AVG(valeur) from etudiants e, notes n where e.matricule=n.code  group by e.nom, e.prenom having AVG(valeur)<=12;";
